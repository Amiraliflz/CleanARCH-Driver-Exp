...
**Updated `tests\Test.FunctionalTests\Test.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\Test.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\Test.FunctionalTests\Test.FunctionalTests.csproj
```
